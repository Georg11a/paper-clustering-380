...
def too_few_rows(group: pd.DataFrame, keyword: str, args: argparse.Namespace) -> pd.DataFrame:
    ...
    rows["contribution_subtype_key"] = ""
    rows["contribution_subtype"] = ""
    rows["contribution_subtype_patterns"] = ""
    rows["contribution_subtype_support"] = ""
    rows["application_domains"] = ""
    rows["primary_application_domain"] = ""
    rows["additional_application_domains"] = ""
