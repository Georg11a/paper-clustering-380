...
### Cluster 0 (7 papers)
Label candidate: Design Guidelines: Meta-Theoretical Reflection on Design
Theory move: Meta-Theoretical Reflection on Design
Theory-move support: 2/7 papers; weighted score 16
Matched patterns: reflects on the nature/role/value of theory (2); explicit meta-theory/metatheory (1)
Summary candidate: The deterministic first-pass typology codes this cluster as meta-theoretical reflection on design. The decision is supported by 2/7 papers; weighted score 16; matched indicators include reflects on the nature/role/value of theory (2); explicit meta-theory/metatheory (1). Representative papers include The Extended Likeability Framework: A Theoretical Framework for and a Practical Case of Designing Likeable Media Applications for Preschoolers; From interaction to trajectories: designing coherent journeys through user experiences.
Design-knowledge contribution: Meta-Theoretical Reflection on Design
Theme words: psi, value, fluent, interfaces, svm, fbs, preschoolers, likeability
...
- 2023: SHEAFIFICATION AS A DESIGN TECHNIQUE FOR CREATIVE PRESERVATION ‚Äì PRINCIPLES, ILLUSTRATIONS, AND FIRST APPLICATIONS
...
Summary candidate: The deterministic first-pass typology did not find enough unambiguous textual evidence to assign this cluster to building, borrowing, testing, or meta-theoretical reflection. It remains flagged for human review rather than being forced into a substantive category. Representative papers include Formalizing Visualization Design Knowledge as Constraints: Actionable and Extensible Models in Draco; Exploring the design space of composite visualization.
Design-knowledge contribution: Unclear Theory Move — Requires Human Review
Theme words: visualization, sonification, atlas, visual, draco, atlases, patterns, views
