...
### Cluster 1 (4 papers)
Label candidate: Architecture / Software / Theoretical
...
Theme words: architecture, software, theoretical, school, guidelines, eating, applications, healthy
...
### Cluster 3 (4 papers)
Label candidate: Geo Portals / Usability / Concept
Summary candidate: This cluster focuses on usability, concept, using Ethnographic, User Study as the main methodological or conceptual lens, with recurring attention to Interface, with contribution types coded as Methodological, Empirical, Theoretical.
Theme words: usability, concept, geo portals, map, trajectories, interfaces, guidelines, rules
...
### Cluster 6 (3 papers)
Label candidate: Participatory Design / Rough Mile / Rural
...
Theme words: rural, immersive, platforms, rough mile, participatory, digital, practice, guidelines
...
Theme words: task, fidelity, training, guidelines, high, don, smells, languages
