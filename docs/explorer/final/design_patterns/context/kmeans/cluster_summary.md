...
### Cluster 1 (3 papers)
Label candidate: Cluster 1: Design Patterns as actionable design guidance
Distinguishing evidence: Create Successful, Application Domain, Terminology Exchange, Presents Approach Uses
...
### Cluster 5 (9 papers)
Label candidate: Cluster 5: Design Patterns through prior-work synthesis
Distinguishing evidence: Evidence Integrity, Enabled Engineering, Courses Aip Framework, Visualization Narration
Summary candidate: This cluster synthesizes prior work on design patterns, emphasizing how a design-knowledge construct is made explicit, organized, or put to work rather than only where it is applied. Conceptually, it treats design patterns as reusable design pattern language. Related forms include Design Guidelines, Design Frameworks. The shared move also involves definition and conceptualization and context-specific adaptation. Its contribution pattern is coded as Methodological, Artifact/System, Taxonomy/Review. Application and method terms are treated as supporting facets, especially contexts such as Sustainability, Climate / Environment. Representative papers include Design Patterns for AI-based Systems: A Multivocal Literature Review and Pattern Repository; Visualization Atlases: Explaining and Exploring Complex Topics Through Data, Visualization, and Narration.
