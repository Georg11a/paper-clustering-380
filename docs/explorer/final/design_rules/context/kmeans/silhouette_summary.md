...
- Requested k range: 2-3
- Dynamic k range after paper-count cap: 2-3
- Selected k: 1
- Selected average silhouette score: n/a
- Distance metric for silhouette: cosine
- Selection note: No candidate k met the minimum cluster-size and balance checks, so this keyword view is kept as one interpretive group.
