...
### Cluster 0 (3 papers)
Label candidate: Design Rules: Theoretical Contribution — Unclear Theory Move — Requires Human Review | Primary Domain: Healthcare, Medicine, Surgery
...
Primary application domain: Healthcare, Medicine, Surgery
...
### Cluster 1 (8 papers)
Label candidate: Design Rules: Artifact Contribution — Interactive Systems and Tools | Primary Domain: Design, Creativity, Architecture
Primary contribution: Artifact Contribution
Secondary contribution: n/a
Contribution support: 2/8 papers; weighted score 6
Contribution subtype: Interactive Systems and Tools
Contribution-subtype support: 3/8 papers
...
Additional application domains: Finance, Business, Economy
...
Summary candidate: This cluster primarily makes a artifact contribution, specifically interactive systems and tools. Its strongest supported application domain is Design, Creativity, Architecture. Additional supported settings are Finance, Business, Economy. Representative papers include Modularity Design Rules for Architecture Development: Theory, Implementation, and Evidence from the Development of the Renault‚ÄìNissan Alliance ‚ÄúCommon Module Family‚Äù Architecture; Hybrid Prototyping: Pure Theory or a Practical Solution to Accelerating Prototyping Tasks?.
