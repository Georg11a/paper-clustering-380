...
Summary candidate: The deterministic first-pass typology codes this cluster as meta-theoretical reflection on design. The decision is supported by 2/18 papers; weighted score 18; matched indicators include explicit meta-theory/metatheory (3); philosophy/epistemology/ontology of design (1). Representative papers include How to Define Design in Industrial Control and Automation Software; A design theory for software engineering.
...
Summary candidate: The deterministic first-pass typology codes this cluster as borrowing theory from other fields. The decision is supported by 4/15 papers; weighted score 28; matched indicators include reference discipline/kernel theory (6); applies/adopts an external theory (1). Representative papers include Management design theories; Editorial: A Critical Look at Theories in Design Science Research.
